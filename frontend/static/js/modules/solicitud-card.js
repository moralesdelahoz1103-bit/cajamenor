...
function crearTarjetaSolicitudBase(solicitud, opciones = {}) {
    ...
    return `
        <div class="solicitud-card">
            ...
            <div class="solicitud-footer" style="margin-top: 16px; display: flex; justify-content: space-between; align-items: center; gap: 12px;">
...
function crearTarjetaSolicitudGerente(solicitud) {
    return crearTarjetaSolicitudEnlace(solicitud);
}
